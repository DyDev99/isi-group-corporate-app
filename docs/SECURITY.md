...
> Security architecture, implementation standards, and development guidelines. Implements `ENGINEERING_STANDARD.md`; encryption implementation detail lives in ``; release-pipeline security gates reference ``'s DevOps section.
