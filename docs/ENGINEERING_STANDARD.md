...
> ISI Corporate Mobile 
> Master engineering rules. Every other document in this set (`ARCHITECTURE.md`, ``, `DATABASE_GUIDE.md`, `SYNC_ENGINE.md`, `SECURITY.md`,`) implements the rules defined here.
> Status: Enterprise Standard · Version 1.0 · Last updated: 2026-07-15
> Source of truth precedence:` (blueprint v2026.1.0) is authoritative** wherever it differs from the earlier `ARCHITECTURE_REVIEW.md`. This document reconciles both.
