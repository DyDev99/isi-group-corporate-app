...
import 'package:isi_group_corporate_app/core/localization/localization_services.dart'; // Handles the .tr extension
import 'package:isi_group_corporate_app/core/localization/localized_builder.dart'; // Triggers reactive rebuilds
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: FutureBuilder<Result<List<NotificationItem>>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (!snapshot.hasData) {
                          return Center(
                            child: Text(
                              'notifications.unexpected_error'.tr,
